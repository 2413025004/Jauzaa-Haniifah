...
<head>
    ...
    <style>
        body {
            ...
            background-image: linear-gradient(135deg, rgba(255, 255, 255, 0.315) 25%, transparent 25%, transparent 75%, rgba(255, 255, 255, 0.39) 75%, rgba(255, 255, 255, 0.1)),
...
<body>
    <header>
        ...
        <h1>2413025004</h1>
        <img id="profile-pic" src="jauzaa.jpeg" alt="FOTO">
